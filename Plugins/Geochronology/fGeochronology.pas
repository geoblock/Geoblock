...
begin
  ...
  case LangID of
    ...
    begin
      ...
      FileName := UpperCase(AppPath +'Data'+PathDelim +'Reference'+ PathDelim +'es'+ PathDelim + 'Geochronology.eng');
      TableAge.TableName := UpperCase(AppPath +'Data'+PathDelim +'Reference'+ PathDelim +'es'+ PathDelim + 'age.db');
      TableEpoch.TableName := UpperCase(AppPath +'Data'+PathDelim +'Reference'+ PathDelim +'es'+ PathDelim + 'epoch.db');
    end;
  end;
